...
# LICENCE INFORMATION                                                          #
#                                                                              #
# This script applies a dark glow grayscale style to an image with a white     #
# background.                                                                  #
#                                                                              #
...
# make grayscale
filename_tmp_grayscale=""${filename_base}"_grayscale.png"
echo "convert image "${filename}" to grayscale "${filename_tmp_grayscale}""
convert "${filename}" -set colorspace Gray -separate -average "${filename_tmp_grayscale}"

# make negative
filename_tmp_negative=""${filename_base}"_negative.png"
echo "convert image "${filename_tmp_grayscale}" to negative "${filename_tmp_negative}""
convert -negate "${filename_tmp_grayscale}" "${filename_tmp_negative}"
